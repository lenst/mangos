...
class MANGOS_DLL_SPEC PlayerbotWarlockAI : PlayerbotClassAI {
 ...
 private:
  bool CastDot(uint32 spellId, Unit *pTarget, int min_mana, int castTime);
  ...
  // AFFLICTION
  uint32 CORRUPTION, DRAIN_SOUL, DRAIN_LIFE, SIPHON_LIFE, UNSTABLE_AFFLICTION, HAUNT, ATROCITY, SEED_OF_CORRUPTION, DARK_PACT, LIFE_TAP;
